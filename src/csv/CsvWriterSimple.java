...
public class CsvWriterSimple {
    ...
    /**
     * Writes in the provided file the provided data as .csv format.
     * First String[] in the list will be the headers.
     * @param list list with the data to write
     * @param file file in what the data will be written
     * @throws IOException If error in the use of file
     */
